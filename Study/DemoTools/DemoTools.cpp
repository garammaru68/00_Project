...
// DemoTools.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CDemoToolsApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CDemoToolsApp::OnAppAbout)
...
CDemoToolsApp::CDemoToolsApp() noexcept
{
	...
	SetAppID(_T("DemoTools.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CDemoToolsApp 개체입니다.

CDemoToolsApp theApp;


// CDemoToolsApp 초기화

BOOL CDemoToolsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDemoToolsDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CDemoToolsView));
	if (!pDocTemplate)
		return FALSE;
...
void CDemoToolsApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CDemoToolsApp 사용자 지정 로드/저장 방법

void CDemoToolsApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDemoToolsApp::LoadCustomState()
{
}

void CDemoToolsApp::SaveCustomState()
{
}
