...
SControlUI* Sample::AddRect(TUI_TYPE type)
{
	...
	case T_BUTTON: {
		...
		pUIControl->Create(g_pd3dDevice, nullptr, L"../../data/tileA.jpg");
...
bool Sample::Init()
{
	UINT id = RegisterWindowMessage(L"WM_SSM");
	...
	pImageCtl->Create(g_pd3dDevice, nullptr, L"../../data/tileA.jpg");
	...
	pBoxCtl->Create(g_pd3dDevice, nullptr, L"../../data/tileA.jpg");
...
#pragma region g_pTextureSRV
	m_pTextureSRV[0].Attach(CreateShaderResourceView(g_pd3dDevice, L"../../data/tileA.jpg"));
	m_pTextureSRV[1].Attach(CreateShaderResourceView(g_pd3dDevice, L"../../data/tileA.jpg"));
	m_pTextureSRV[2].Attach(CreateShaderResourceView(g_pd3dDevice, L"../../data/tileA.jpg"));
...
bool Sample::Render()
{
	...
	// 2초당 1회전( 1 초 * SBASIS_PI = 3.14 )
//	float t = g_Timer.GetElapsedTime() * SBASIS_PI;
