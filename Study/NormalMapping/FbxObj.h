...
public:
	...
	void ParseNode(FbxNode* pNode, Matrix  matParent, ModelObj* pParentObj);
	void ParseMesh(FbxNode* pNode, FbxMesh*  pMesh, ModelObj* pObj);
	...
	bool ParseMeshSkinningMap(const FbxMesh* pFbxMesh, std::vector<SWeight>& skindata, ModelObj* pObj);
