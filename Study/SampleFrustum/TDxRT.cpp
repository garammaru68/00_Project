#include "TDxRT.h"
void		TDxRT::Set(	ID3D11Device*	pd3dDevice)
{
	m_pd3dDevice = pd3dDevice;
}
HRESULT		TDxRT::SetRenderTargetView()
{
	HRESULT hr;
...
HRESULT TDxRT::SetDepthStencilView()
{
...
void TDxRT::ClearShaderResources(ID3D11DeviceContext*  pImmediateContext)
{
	// unbind resources
...
bool TDxRT::Begin(ID3D11DeviceContext*	pd3dContext)
{
	UINT  iNumView = 1;
...
bool TDxRT::End(ID3D11DeviceContext*	pd3dContext)
{
