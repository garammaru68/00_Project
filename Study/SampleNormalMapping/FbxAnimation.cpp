#include "FbxObj.h"
void FbxObj::AddKey(FbxNode* pNode, FbxAMatrix matGlobal,
	float fCurrentTime)
{
...
bool FbxObj::ParseMeshSkinningMap(const FbxMesh* pFbxMesh,
	std::vector<SWeight>& skindata, ModelObj* pObj)
{
...
void FbxObj::ParseAnimation(FbxScene*	pFbxScene)
{
...
void FbxObj::ParseNodeAnimation(FbxNode* pNode)
{
...
void FbxObj::ParseAnimStack(FbxScene* pFbxScene,
