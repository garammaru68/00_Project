...
std::string FbxObj::ParseMaterial(FbxSurfaceMaterial* pMtrl)
{
...
bool FbxObj::Load(std::string szFileName)
{
...
bool FbxObj::Initialize(std::string szFileName)
{
...
bool FbxObj::LoadFBX(std::string szFileName)
{
...
void FbxObj::ParseMesh(FbxNode* pNode,
	FbxMesh*  pFbxMesh,
	ModelObj* pObj)
{
...
Matrix FbxObj::ParseTransform(FbxNode* pNode, Matrix& matParentWorld)
{
	Matrix matWorld = Matrix::Identity;
	return matWorld;
}
void FbxObj::ParseNode(
	FbxNode* pNode,
	Matrix  matParent, ModelObj* pParentObj)
{
...
FbxVector4 FbxObj::ReadNormal(const FbxMesh* mesh,
...
FbxColor FbxObj::ReadColor(const FbxMesh* mesh,
...
FbxVector4 FbxObj::ReadTangent(const FbxMesh* mesh,
