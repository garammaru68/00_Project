...
typedef std::unordered_map<FbxNode*, TModelObj*>	tNodeMap;
typedef std::vector<TModelObj*>	tNodeList;
class TFbxObj : public SObject
{
public:
	int		  m_iMax = 0;
	TScene    m_Scene;
...
public:
	...
	void ParseMesh(FbxNode* pNode, FbxMesh*  pMesh, TModelObj* pObj);
