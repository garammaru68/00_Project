...
namespace SBASIS_EX
{
	...
	****************************************************************************/
	...
	void SVector2::Transform(const SVector2& v, const SDxMatrix& m, SVector2& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
	...
	SVector2 SVector2::Transform(const SVector2& v, const SDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	_Use_decl_annotations_
		void SVector2::Transform(const SVector2* varray, size_t count, const SDxMatrix& m, SVector2* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	void SVector2::Transform(const SVector2& v, const SDxMatrix& m, SVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	_Use_decl_annotations_
		void SVector2::Transform(const SVector2* varray, size_t count, const SDxMatrix& m, SVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4  *)&m);
	...
	void SVector2::TransformNormal(const SVector2& v, const SDxMatrix& m, SVector2& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	SVector2 SVector2::TransformNormal(const SVector2& v, const SDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void SVector2::TransformNormal(const SVector2* varray, size_t count, const SDxMatrix& m, SVector2* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	****************************************************************************/
	...
	void SVector3::Transform(const SVector3& v, const SDxMatrix& m, SVector3& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
	...
	SVector3 SVector3::Transform(const SVector3& v, const SDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void SVector3::Transform(const SVector3* varray, size_t count, const SDxMatrix& m, SVector3* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void SVector3::Transform(const SVector3& v, const SDxMatrix& m, SVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void SVector3::Transform(const SVector3* varray, size_t count, const SDxMatrix& m, SVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void SVector3::TransformNormal(const SVector3& v, const SDxMatrix& m, SVector3& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	SVector3 SVector3::TransformNormal(const SVector3& v, const SDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void SVector3::TransformNormal(const SVector3* varray, size_t count, const SDxMatrix& m, SVector3* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void SVector4::Transform(const SVector4& v, const SDxMatrix& m, SVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat4(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	SVector4 SVector4::Transform(const SVector4& v, const SDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat4(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void SVector4::Transform(const SVector4* varray, size_t count, const SDxMatrix& m, SVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	****************************************************************************/
	...
	bool SDxMatrix::operator == (const SDxMatrix& M) const
	{
		using namespace DirectX;
	...
	SDxMatrix::SDxMatrix(const XMFLOAT3X3& M)
	{
	...
	SDxMatrix::SDxMatrix(const XMFLOAT4X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	SDxMatrix& SDxMatrix::operator= (const XMFLOAT3X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	SDxMatrix& SDxMatrix::operator= (const XMFLOAT4X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	SDxMatrix& SDxMatrix::operator+= (const SDxMatrix& M)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
	...
	SDxMatrix& SDxMatrix::operator*= (float S)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
	...
	SDxMatrix SDxMatrix::operator- () const
	{
		using namespace DirectX;
	...
	bool SDxMatrix::Decompose(SVector3& scale, SQuaternion& rotation, SVector3& translation)
	{
		using namespace DirectX;
	...
	SDxMatrix SDxMatrix::Transpose() const
	{
		using namespace DirectX;
	...
	void SDxMatrix::Transpose(SDxMatrix& result) const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
	...
	SDxMatrix SDxMatrix::Invert() const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
		SDxMatrix R;
	...
	void SDxMatrix::Invert(SDxMatrix& result) const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
		XMVECTOR det;
	...
	float SDxMatrix::Determinant() const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
	...
	_Use_decl_annotations_
		SDxMatrix SDxMatrix::CreateBillboard(const SVector3& object, const SVector3& cameraPosition, const SVector3& cameraUp, const SVector3* cameraForward)
	{
		using namespace DirectX;
	...
	_Use_decl_annotations_
		SDxMatrix SDxMatrix::CreateConstrainedBillboard(const SVector3& object, const SVector3& cameraPosition, const SVector3& rotateAxis,
	...
	SDxMatrix SDxMatrix::CreateTranslation(const SVector3& position)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateTranslation(float x, float y, float z)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateScale(const SVector3& scales)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateScale(float xs, float ys, float zs)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateScale(float scale)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateRotationX(float radians)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateRotationY(float radians)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateRotationZ(float radians)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateFromAxisAngle(const SVector3& axis, float angle)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreatePerspective(float width, float height, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateLookAt(const SVector3& eye, const SVector3& target, const SVector3& up)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateWorld(const SVector3& position, const SVector3& forward, const SVector3& up)
	{
		using namespace DirectX;
	...
	SDxMatrix SDxMatrix::CreateFromQuaternion(const SQuaternion& rotation)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateFromYawPitchRoll(float yaw, float pitch, float roll)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateShadow(const SVector3& lightDir, const SPlane& plane)
	{
		using namespace DirectX;
		SDxMatrix R;
	...
	SDxMatrix SDxMatrix::CreateReflection(const SPlane& plane)
	{
		using namespace DirectX;
		SDxMatrix R;
		XMVECTOR planev = XMLoadFloat4(&plane);
	...
	void SDxMatrix::Lerp(const SDxMatrix& M1, const SDxMatrix& M2, float t, SDxMatrix& result)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
	...
	SDxMatrix SDxMatrix::Lerp(const SDxMatrix& M1, const SDxMatrix& M2, float t)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
	...
	void SDxMatrix::Transform(const SDxMatrix& M, const SQuaternion& rotation, SDxMatrix& result)
	{
		using namespace DirectX;
		XMVECTOR quatv = XMLoadFloat4(&rotation);
	...
	SDxMatrix SDxMatrix::Transform(const SDxMatrix& M, const SQuaternion& rotation)
	{
		using namespace DirectX;
		XMVECTOR quatv = XMLoadFloat4(&rotation);
	...
	****************************************************************************/
	...
	void SPlane::Transform(const SPlane& plane, const SDxMatrix& M, SPlane& result)
	{
		using namespace DirectX;
	...
	SPlane SPlane::Transform(const SPlane& plane, const SDxMatrix& M)
	{
		using namespace DirectX;
		XMVECTOR p = XMLoadFloat4(&plane);
		XMMATRIX m0 = XMLoadFloat4x4(&M);
	...
	****************************************************************************/
	...
	SQuaternion SQuaternion::CreateFromRotationMatrix(const SDxMatrix& M)
	{
		using namespace DirectX;
		XMMATRIX M0 = XMLoadFloat4x4(&M);
	...
	****************************************************************************/
	...
	SVector3 SViewport::Project(const SVector3& p, const SDxMatrix& proj, const SDxMatrix& view, const SDxMatrix& world) const
	{
		using namespace DirectX;
	...
	void SViewport::Project(const SVector3& p, const SDxMatrix& proj, const SDxMatrix& view, const SDxMatrix& world, SVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	SVector3 SViewport::Unproject(const SVector3& p, const SDxMatrix& proj, const SDxMatrix& view, const SDxMatrix& world) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	void SViewport::Unproject(const SVector3& p, const SDxMatrix& proj, const SDxMatrix& view, const SDxMatrix& world, SVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
