...
namespace TBASIS_EX
{
	...
	****************************************************************************/
	...
	void TVector2::Transform(const TVector2& v, const TDxMatrix& m, TVector2& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
	...
	TVector2 TVector2::Transform(const TVector2& v, const TDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	_Use_decl_annotations_
		void TVector2::Transform(const TVector2* varray, size_t count, const TDxMatrix& m, TVector2* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	void TVector2::Transform(const TVector2& v, const TDxMatrix& m, TVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4 *)&m);
	...
	_Use_decl_annotations_
		void TVector2::Transform(const TVector2* varray, size_t count, const TDxMatrix& m, TVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4  *)&m);
	...
	void TVector2::TransformNormal(const TVector2& v, const TDxMatrix& m, TVector2& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	TVector2 TVector2::TransformNormal(const TVector2& v, const TDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat2(&v);
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void TVector2::TransformNormal(const TVector2* varray, size_t count, const TDxMatrix& m, TVector2* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((DirectX::XMFLOAT4X4*)&m);
	...
	****************************************************************************/
	...
	void TVector3::Transform(const TVector3& v, const TDxMatrix& m, TVector3& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
	...
	TVector3 TVector3::Transform(const TVector3& v, const TDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void TVector3::Transform(const TVector3* varray, size_t count, const TDxMatrix& m, TVector3* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void TVector3::Transform(const TVector3& v, const TDxMatrix& m, TVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void TVector3::Transform(const TVector3* varray, size_t count, const TDxMatrix& m, TVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void TVector3::TransformNormal(const TVector3& v, const TDxMatrix& m, TVector3& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	TVector3 TVector3::TransformNormal(const TVector3& v, const TDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat3(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void TVector3::TransformNormal(const TVector3* varray, size_t count, const TDxMatrix& m, TVector3* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	void TVector4::Transform(const TVector4& v, const TDxMatrix& m, TVector4& result)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat4(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	TVector4 TVector4::Transform(const TVector4& v, const TDxMatrix& m)
	{
		using namespace DirectX;
		XMVECTOR v1 = XMLoadFloat4(&v);
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	_Use_decl_annotations_
		void TVector4::Transform(const TVector4* varray, size_t count, const TDxMatrix& m, TVector4* resultArray)
	{
		using namespace DirectX;
		XMMATRIX M = XMLoadFloat4x4((XMFLOAT4X4*)&m);
	...
	****************************************************************************/
	...
	bool TDxMatrix::operator == (const TDxMatrix& M) const
	{
		using namespace DirectX;
	...
	TDxMatrix::TDxMatrix(const XMFLOAT3X3& M)
	{
	...
	TDxMatrix::TDxMatrix(const XMFLOAT4X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	TDxMatrix& TDxMatrix::operator= (const XMFLOAT3X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	TDxMatrix& TDxMatrix::operator= (const XMFLOAT4X3& M)
	{
		_11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
		_21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
		_31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
	...
	TDxMatrix& TDxMatrix::operator+= (const TDxMatrix& M)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
	...
	TDxMatrix& TDxMatrix::operator*= (float S)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
	...
	TDxMatrix TDxMatrix::operator- () const
	{
		using namespace DirectX;
	...
	bool TDxMatrix::Decompose(TVector3& scale, TQuaternion& rotation, TVector3& translation)
	{
		using namespace DirectX;
	...
	TDxMatrix TDxMatrix::Transpose() const
	{
		using namespace DirectX;
	...
	void TDxMatrix::Transpose(TDxMatrix& result) const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
	...
	TDxMatrix TDxMatrix::Invert() const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
		TDxMatrix R;
	...
	void TDxMatrix::Invert(TDxMatrix& result) const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
		XMVECTOR det;
	...
	float TDxMatrix::Determinant() const
	{
		using namespace DirectX;
		FXMMATRIX M = XMLoadFloat4x4(this);
	...
	_Use_decl_annotations_
		TDxMatrix TDxMatrix::CreateBillboard(const TVector3& object, const TVector3& cameraPosition, const TVector3& cameraUp, const TVector3* cameraForward)
	{
		using namespace DirectX;
	...
	_Use_decl_annotations_
		TDxMatrix TDxMatrix::CreateConstrainedBillboard(const TVector3& object, const TVector3& cameraPosition, const TVector3& rotateAxis,
	...
	TDxMatrix TDxMatrix::CreateTranslation(const TVector3& position)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateTranslation(float x, float y, float z)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateScale(const TVector3& scales)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateScale(float xs, float ys, float zs)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateScale(float scale)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateRotationX(float radians)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateRotationY(float radians)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateRotationZ(float radians)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateFromAxisAngle(const TVector3& axis, float angle)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreatePerspective(float width, float height, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateLookAt(const TVector3& eye, const TVector3& target, const TVector3& up)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateWorld(const TVector3& position, const TVector3& forward, const TVector3& up)
	{
		using namespace DirectX;
	...
	TDxMatrix TDxMatrix::CreateFromQuaternion(const TQuaternion& rotation)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateFromYawPitchRoll(float yaw, float pitch, float roll)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateShadow(const TVector3& lightDir, const TPlane& plane)
	{
		using namespace DirectX;
		TDxMatrix R;
	...
	TDxMatrix TDxMatrix::CreateReflection(const TPlane& plane)
	{
		using namespace DirectX;
		TDxMatrix R;
		XMVECTOR planev = XMLoadFloat4(&plane);
	...
	void TDxMatrix::Lerp(const TDxMatrix& M1, const TDxMatrix& M2, float t, TDxMatrix& result)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
	...
	TDxMatrix TDxMatrix::Lerp(const TDxMatrix& M1, const TDxMatrix& M2, float t)
	{
		using namespace DirectX;
		XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
		XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
	...
	void TDxMatrix::Transform(const TDxMatrix& M, const TQuaternion& rotation, TDxMatrix& result)
	{
		using namespace DirectX;
		XMVECTOR quatv = XMLoadFloat4(&rotation);
	...
	TDxMatrix TDxMatrix::Transform(const TDxMatrix& M, const TQuaternion& rotation)
	{
		using namespace DirectX;
		XMVECTOR quatv = XMLoadFloat4(&rotation);
	...
	****************************************************************************/
	...
	void TPlane::Transform(const TPlane& plane, const TDxMatrix& M, TPlane& result)
	{
		using namespace DirectX;
	...
	TPlane TPlane::Transform(const TPlane& plane, const TDxMatrix& M)
	{
		using namespace DirectX;
		XMVECTOR p = XMLoadFloat4(&plane);
		XMMATRIX m0 = XMLoadFloat4x4(&M);
	...
	****************************************************************************/
	...
	TQuaternion TQuaternion::CreateFromRotationMatrix(const TDxMatrix& M)
	{
		using namespace DirectX;
		XMMATRIX M0 = XMLoadFloat4x4(&M);
	...
	****************************************************************************/
	...
	TVector3 TViewport::Project(const TVector3& p, const TDxMatrix& proj, const TDxMatrix& view, const TDxMatrix& world) const
	{
		using namespace DirectX;
	...
	void TViewport::Project(const TVector3& p, const TDxMatrix& proj, const TDxMatrix& view, const TDxMatrix& world, TVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	TVector3 TViewport::Unproject(const TVector3& p, const TDxMatrix& proj, const TDxMatrix& view, const TDxMatrix& world) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
	...
	void TViewport::Unproject(const TVector3& p, const TDxMatrix& proj, const TDxMatrix& view, const TDxMatrix& world, TVector3& result) const
	{
		using namespace DirectX;
		XMVECTOR v = XMLoadFloat3(&p);
		XMMATRIX projection = XMLoadFloat4x4(&proj);
